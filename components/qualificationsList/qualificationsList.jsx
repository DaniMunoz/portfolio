        ...
        <figcaption className="text-sm sm:text-base font-medium">          
          ...
          { qualification.type == 'degree' && 
            <div className="absolute bottom-3 right-3 text-blue-500">
              { (language == "en") && <><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline">
                                          ...
                                          &nbsp;<a href={qualification.link} className="underline bg-gradient-to-r from-blue-400 to-green-500 hover:from-blue-500 hover:to-green-600 text-white font-bold py-1 px-2 rounded-md hover:rounded-lg text-[12px]" target="_blank" rel="noreferrer">See University Degree</a>
                                          </>}
            { (language == "es") && <><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline">
                                      ...
                                      &nbsp;<a href={qualification.link} className="underline bg-gradient-to-r from-blue-400 to-green-500 hover:from-blue-500 hover:to-green-600 text-white font-bold py-1 px-2 rounded-md hover:rounded-lg text-[12px]" target="_blank" rel="noreferrer">Ver Título Universitario</a>
                                      </>}
            </div>}
          ...
          { qualification.type == 'certification' &&
            ...
            { (language == "en") && <><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline text-green-500">
                                    ...
                                    &nbsp;<a href={qualification.link} className="underline bg-gradient-to-r from-blue-400 to-green-500 hover:from-blue-500 hover:to-green-600 text-white font-bold py-1 px-2 rounded-md hover:rounded-lg text-[12px]" target="_blank" rel="noreferrer">See Certification</a>
                                    </>}
            { (language == "es") && <><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline text-green-500">
                                    ...
                                    &nbsp;<a href={qualification.link} className="underline bg-gradient-to-r from-blue-400 to-green-500 hover:from-blue-500 hover:to-green-600 text-white font-bold py-1 px-2 rounded-md hover:rounded-lg text-[12px]" target="_blank" rel="noreferrer">Ver Certificación</a>
                                    </>}
            </div>          
          }
        </figcaption>
